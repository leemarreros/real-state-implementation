...
contract ERC721 is Pausable, ERC165 {
    ...
    function approve(address to, uint256 tokenId) public {
        ...
        require(
            ...
            "Address to aprove cannot be the owner address."
        );
        // TODO require the msg sender to be the owner of the contract or isApprovedForAll() to be true
        require(
            msg.sender == _tokenOwner[tokenId],
            "Caller of this method is not the owner of the token."
        );
    ...
    function getApproved(uint256 tokenId) public view returns (address) {
        ...
        address addressApproved = _tokenApprovals[tokenId];
        require(
            addressApproved != address(0),
            "Does not exist approved address for this token."
        );
    ...
    function _mint(address to, uint256 tokenId) internal {
        ...
        require(_exists(tokenId), "This token exists already.");
...
contract ERC721Metadata is ERC721Enumerable, usingOraclize {
    ...
    mapping(string => string) private _tokenURISs;
    ...
    function setTokenURI(uint256 tokenId) internal {
        ...
        _tokenURISs[tokenId] = strConcat(_baseTokenURI, tokenId);
    }
}
